...
PDF_URL = "https://example.com/style-guide.pdf"  # Сюда вставишь свою ссылку на PDF

QUESTIONS = [
{
"text": "Вопрос 1 из 10 👗\n\nПредстав, что ты открываешь шкаф утром в обычный день.\nКакой силуэт одежды ты тянешься надеть в первую очередь?",
"options": [
...
{
"text": "Вопрос 2 из 10 🎨\n\nПосмотри на свой гардероб.\nКакие цвета встречаются в нём чаще всего?",
"options": [
("🖤 Нейтральные: чёрный, белый, серый, бежевый", "klassika"),
("🌸 Пастельные: розовый, лавандовый, пудровый", "romantika"),
("🌿 Натуральные: хаки, джинс, белый, оливковый", "casual"),
],
},
{
"text": "Вопрос 3 из 10 👠\n\nКакую обувь ты надеваешь чаще всего в обычной жизни?",
"options": [
("👠 Каблук, лодочки, классические туфли", "klassika"),
("🥿 Балетки, мюли, изящные сандалии", "romantika"),
("👟 Кеды, лоферы, кроссовки, слипоны", "casual"),
],
},
{
"text": "Вопрос 4 из 10 🧵\n\nКакие ткани тебе нравятся больше всего на ощупь и внешне?",
"options": [
("✨ Шерсть, шёлк, хлопок без принта", "klassika"),
("🌸 Кружево, шифон, атлас, с цветами", "romantika"),
("🌿 Деним, лён, трикотаж, натуральный хлопок", "casual"),
],
},
{
"text": "Вопрос 5 из 10 👜\n\nТы собираешься на встречу.\nКакой аксессуар ты возьмёшь в первую очередь?",
"options": [
("👜 Структурированная сумка, ремень, часы", "klassika"),
("💐 Украшения, платок, изящная сумочка-клатч", "romantika"),
("🎒 Рюкзак, тоут, минимум аксессуаров", "casual"),
],
},
{
"text": "Вопрос 6 из 10 👒\n\nКак ты себя чувствуешь в платье?",
"options": [
("💼 Уверенно, если оно строгое и по фигуре", "klassika"),
("🌸 Обожаю платья — чем женственнее, тем лучше", "romantika"),
("😅 Редко ношу, предпочитаю брюки или джинсы", "casual"),
],
},
{
"text": "Вопрос 7 из 10 💼\n\nПредстав важную деловую встречу.\nЧто ты наденешь?",
"options": [
("👔 Костюм или блузка с брюками", "klassika"),
("🌸 Платье миди с украшениями", "romantika"),
("🌿 Чистые джинсы и красивый топ или рубашка", "casual"),
],
},
{
"text": "Вопрос 8 из 10 🛍️\n\nТы в магазине.\nЧто ты берёшь в примерочную в первую очередь?",
"options": [
("🖤 Проверенную классику — всегда выгляжу хорошо", "klassika"),
("🌸 То, что поднимает настроение и радует глаз", "romantika"),
("🌿 То, в чём удобно и можно весь день не думать", "casual"),
],
},
{
"text": "Вопрос 9 из 10 🏢\n\nТвой идеальный образ на работу — какой он?",
"options": [
("💼 Строгий, аккуратный, без лишних деталей", "klassika"),
("🌸 Женственный, с деталями, запоминающийся", "romantika"),
("🌿 Удобный, практичный, но стильный", "casual"),
],
},
{
